...
class Base extends JComponent{
     ...
     */
    public void setSize(int sizeX, int sizeY, JComponent todo) {
     ...
     * @param y the Y cor
     */
    public void setPos(int x, int y,JComponent todo) {
     ...
     */
    public void setColor(Color color, JComponent todo) {
